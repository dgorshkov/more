...
- **[Worldbuilding](docs/narrative/worldbuilding.md)** - Factions, technology, and timeline
...
└── docs/               # All project documentation
    ├── narrative/      # Story content and writing guidelines
    ├── design/         # Game design documents and specifications
    └── technical/      # Technical documentation and architecture
```

Additional directories for game implementation and tooling will be added when development begins.
